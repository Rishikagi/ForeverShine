        ...
        {isMobileMenuOpen && (
          <div className="absolute top-full left-0 w-full bg-white shadow-lg md:hidden">
            <ul className="py-2">
              ...
              <li className="hover:bg-teal-50">
                <Link to="/car-care" className="block px-4 py-2 text-gray-800 hover:text-teal-700">Car care</Link>
              </li>
              <li className="hover:bg-teal-50">
                <Link to="/home-care" className="block px-4 py-2 text-gray-800 hover:text-teal-700">Home care</Link>
              </li>
              <li className="hover:bg-teal-50">
                <Link to="/personal-care" className="block px-4 py-2 text-gray-800 hover:text-teal-700">
                  Personal care
                  <span className="text-xs text-gray-400 ml-2">(Coming Soon)</span>
                </Link>
              </li>
              <li className="hover:bg-teal-50">
                <Link to="/about-us" className="block px-4 py-2 text-gray-800 hover:text-teal-700">About us</Link>
              </li>
            </ul>
          </div>
        )}
